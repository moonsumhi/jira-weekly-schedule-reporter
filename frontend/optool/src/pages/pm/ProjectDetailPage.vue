...
const issueCounts = ref<Record<IssueStatus, number>>({ BACKLOG: 0, TODO: 0, IN_PROGRESS: 0, IMPLEMENTED: 0, DONE: 0 })
...
onMounted(async () => {
  ...
  try {
    ...
    const counts: Record<IssueStatus, number> = { BACKLOG: 0, TODO: 0, IN_PROGRESS: 0, IMPLEMENTED: 0, DONE: 0 }
