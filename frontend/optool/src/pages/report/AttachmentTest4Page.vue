<template>
  <q-page class="q-pa-md">
    <div class="row q-col-gutter-md">
      ...
      <!-- 헤더 -->
      <div class="col-12">
        <div class="text-h5">[pilot]첨부파일 test4</div>
        <div class="text-caption text-grey-7">주간 Jira 업무 현황 보고서 (첨부파일 test4)</div>
      </div>
      ...
      <div v-if="groups.length > 0" class="col-12">
        ...
        <q-card flat bordered class="q-mb-md">
          <q-card-section class="bg-primary text-white">
            <div class="text-h6 text-weight-bold">[pilot]첨부파일 test4</div>
