...
OPERATOR_ALLOWED_TARGETS  = {"REVIEWING", "PENDING_INFO", "IN_PROGRESS", "COMPLETED", "CONFIRMING"}
MANAGER_ALLOWED_TARGETS   = {"REVIEWING", "APPROVED", "REJECTED", "ON_HOLD", "PENDING_INFO", "ASSIGNED", "CONFIRMING", "CLOSED"}
